 ...
 * @since 1.1.0
 */
class Ic_reservation extends Widget_Base {
	...
	public function get_title() {
		return __( 'IC Reservation', 'ic-elements' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Reservation form shortcode', 'ic-elements' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ic-reservation' => 'text-align: {{VALUE}};',
				],
				'default' => 'left',
				'toggle' => true,
			]
